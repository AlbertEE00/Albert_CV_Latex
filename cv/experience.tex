...
{2022 (5 weeks)} % Date(s)
{
	\begin{cvitems} % Description(s) of tasks/responsibilities
		\item {Worked alongside IC Engineers on designing a custom testing station for IP}
		\item {Worked on data analysis of manufactured IC wafer's data, wrote Python software to utilize HDF5 formats over csv to optimize data analysis.}
	\end{cvitems}
}
